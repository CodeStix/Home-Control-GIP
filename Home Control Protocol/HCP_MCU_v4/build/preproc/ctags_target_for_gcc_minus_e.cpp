...
# 703 "/Users/stijnrogiest/Documents/GitHub/Home-Control-GIP/Home Control Protocol/HCP_MCU_v4/HCP_MCU_v4.ino"
  unsigned char deviceCount = 0;
  ...
  for (int i = 0; i < 64; i++)
  {
    ...
    else
    {
      ...
      Serial.println();*/
# 722 "/Users/stijnrogiest/Documents/GitHub/Home-Control-GIP/Home Control Protocol/HCP_MCU_v4/HCP_MCU_v4.ino"
      deviceCount++;
    }
  }
...
void saveDevicesToRom()
{
  ...
  for (int i = 0; i < 64; i++)
  {
    if (devices[i])
    {
      ...
      Serial.println();*/
# 762 "/Users/stijnrogiest/Documents/GitHub/Home-Control-GIP/Home Control Protocol/HCP_MCU_v4/HCP_MCU_v4.ino"
